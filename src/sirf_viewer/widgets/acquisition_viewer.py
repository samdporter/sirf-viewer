...
class SIRFAcquisitionViewerWidget(QWidget):
    ...
    def set_data(self, data: Any):
        ...
        """
        if not hasattr(data, '__class__') or data.__class__.__name__ != 'AcquisitionData':
    ...
    def calculate_optimal_window_level(self, percentile: float = 98.0) -> Tuple[float, float]:
